    ...
    def findSafeWalk(self, grid: List[List[int]], health: int) -> bool:
        ...
        while queue:
            ...
            if row == m - 1 and col == n - 1:
                ...
                # But for destination, we need curr_health > 0 after visiting.
                # Since we checked curr_health > grid[row][col] before subtracting
                # and subtracted, curr_health > 0 holds.
                return True
